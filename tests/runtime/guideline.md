...
- `game_runtime_projection_test.cpp`: Verifies projected runtime/UI state output, including site bootstrap, inventory presentation, and phone listing removal emission when listings disappear.
