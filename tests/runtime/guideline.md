...
- `game_runtime_projection_test.cpp`: Verifies projected runtime/UI state output, including site bootstrap, inventory presentation, authoritative phone panel state emission, and phone listing add/remove projection behavior.
