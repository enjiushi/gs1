...
- `source/`: Source-authored system tests compiled into the test host, including harvest-action and harvested-output regressions plus faction-tech base/enhancement progression coverage.
