...
- `source/`: Source-authored system tests compiled directly into the standalone host, including harvest-action, harvested-output, and excavation-action regressions plus faction-tech base/enhancement progression coverage, Village recipe gating, shovel carry bonuses, pack-slot growth, and timed-buff-slot coverage.
