...
void technology_first_basic_tier_auto_unlocks_with_faction_requirement(
    gs1::testing::SystemTestExecutionContext& context)
{
    auto campaign = make_campaign();
    ...
    campaign.faction_progress[0].faction_reputation = reputation_for_progress_tier(1U);

    GS1_SYSTEM_TEST_CHECK(
        context,
        TechnologySystem::faction_reputation(campaign, gs1::FactionId {gs1::k_faction_village_committee}) ==
            reputation_for_progress_tier(1U));
    GS1_SYSTEM_TEST_CHECK(
        context,
        TechnologySystem::node_purchased(
            campaign,
...
void technology_auto_unlock_uses_node_faction_reputation_not_selected_tab(
    gs1::testing::SystemTestExecutionContext& context)
{
    auto campaign = make_campaign();
    const auto village_tier_one = gs1::base_technology_node_id(
    ...
    GS1_SYSTEM_TEST_CHECK(
        ...
        TechnologySystem::faction_reputation(campaign, gs1::FactionId {gs1::k_faction_agricultural_university}) ==
            reputation_for_progress_tier(20U));
}

void technology_linear_tiers_auto_unlock_from_matching_reputation_bands(
    gs1::testing::SystemTestExecutionContext& context)
{
    auto campaign = make_campaign();
    ...
    campaign.faction_progress[1].faction_reputation = reputation_for_progress_tier(2U);

    GS1_SYSTEM_TEST_CHECK(
        context,
        TechnologySystem::node_purchased(campaign, gs1::TechNodeId {forestry_tier_two}));

    campaign.faction_progress[1].faction_reputation = reputation_for_progress_tier(31U);
    GS1_SYSTEM_TEST_CHECK(
        context,
        !TechnologySystem::node_purchased(campaign, gs1::TechNodeId {forestry_tier_thirty_two}));

    campaign.faction_progress[1].faction_reputation = reputation_for_progress_tier(32U);
    GS1_SYSTEM_TEST_CHECK(
        context,
        TechnologySystem::node_purchased(campaign, gs1::TechNodeId {forestry_tier_thirty_two}));
}

void technology_auto_unlocks_do_not_expose_claim_or_refund_actions(
    gs1::testing::SystemTestExecutionContext& context)
{
    auto campaign = make_campaign();
    const auto village_tier_one = gs1::base_technology_node_id(
    ...
    const auto village_tier_two = gs1::base_technology_node_id(
        gs1::FactionId {gs1::k_faction_village_committee},
        2U);
    campaign.faction_progress[0].faction_reputation = reputation_for_progress_tier(2U);

    const auto* tier_one_node =
        gs1::find_technology_node_def(gs1::TechNodeId {village_tier_one});
    const auto* tier_two_node =
        gs1::find_technology_node_def(gs1::TechNodeId {village_tier_two});
    GS1_SYSTEM_TEST_REQUIRE(context, tier_one_node != nullptr);
    ...
    GS1_SYSTEM_TEST_CHECK(context, !TechnologySystem::node_claimable(campaign, *tier_one_node));
    GS1_SYSTEM_TEST_CHECK(context, !TechnologySystem::node_claimable(campaign, *tier_two_node));
}
    ...
    gs1::testing::SystemTestExecutionContext& context)
{
    ...
    GS1_SYSTEM_TEST_CHECK(
        context,
        TechnologySystem::current_internal_cost_cash_points(*village_tier_one) == 0U);
    GS1_SYSTEM_TEST_CHECK(context, TechnologySystem::current_cash_cost(campaign, *village_tier_one) == 0);
    GS1_SYSTEM_TEST_CHECK(
        context,
        TechnologySystem::current_reputation_requirement(*village_tier_one) == reputation_for_progress_tier(1U));
    GS1_SYSTEM_TEST_CHECK(
        context,
    ...
    GS1_SYSTEM_TEST_CHECK(
        context,
        TechnologySystem::current_internal_cost_cash_points(*village_tier_thirty_two) == 0U);
    GS1_SYSTEM_TEST_CHECK(
        context,
        TechnologySystem::current_reputation_requirement(*village_tier_thirty_two) ==
            reputation_for_progress_tier(32U));
    GS1_SYSTEM_TEST_CHECK(
        context,
        TechnologySystem::current_effect_parameter(campaign, *university_tier_one) > 1.0f);
    GS1_SYSTEM_TEST_CHECK(
        context,
        university_tier_one->granted_content_kind == gs1::TechnologyGrantedContentKind::Plant);
}
    ...
    gs1::testing::SystemTestExecutionContext& context)
{
    ...
    campaign.faction_progress[0].faction_reputation = reputation_for_progress_tier(8U);
    GS1_SYSTEM_TEST_CHECK(
        context,
        TechnologySystem::node_purchased(
            campaign,
    ...
    campaign.faction_progress[1].faction_reputation = reputation_for_progress_tier(5U);
    GS1_SYSTEM_TEST_CHECK(
        context,
        TechnologySystem::recipe_unlocked(campaign, gs1::RecipeId {gs1::k_recipe_craft_herbal_poultice}));

    campaign.faction_progress[2].faction_reputation = reputation_for_progress_tier(1U);
    GS1_SYSTEM_TEST_CHECK(
        context,
        TechnologySystem::plant_unlocked(campaign, gs1::PlantId {gs1::k_plant_aromatic_wormwood}));
    GS1_SYSTEM_TEST_CHECK(
        context,
        TechnologySystem::item_unlocked(campaign, gs1::ItemId {gs1::k_item_aromatic_wormwood_seed_bundle}));

    campaign.faction_progress[1].faction_reputation = reputation_for_progress_tier(9U);
    GS1_SYSTEM_TEST_CHECK(
        context,
        TechnologySystem::item_unlocked(campaign, gs1::ItemId {gs1::k_item_focus_tonic}));

    campaign.faction_progress[2].faction_reputation = reputation_for_progress_tier(13U);
    GS1_SYSTEM_TEST_CHECK(
        context,
        TechnologySystem::plant_unlocked(campaign, gs1::PlantId {gs1::k_plant_potent_desert_ephedra}));

    campaign.faction_progress[2].faction_reputation = reputation_for_progress_tier(29U);
    GS1_SYSTEM_TEST_CHECK(
        context,
        TechnologySystem::plant_unlocked(campaign, gs1::PlantId {gs1::k_plant_selected_wolfberry}));

    campaign.faction_progress[1].faction_reputation = reputation_for_progress_tier(20U);
    GS1_SYSTEM_TEST_CHECK(
        context,
        TechnologySystem::structure_recipe_unlocked(campaign, gs1::StructureId {gs1::k_structure_wind_fence}));
    GS1_SYSTEM_TEST_CHECK(
    ...
    campaign.faction_progress[0].faction_reputation = reputation_for_progress_tier(32U);
    GS1_SYSTEM_TEST_CHECK(
        context,
        TechnologySystem::recipe_unlocked(campaign, gs1::RecipeId {gs1::k_recipe_cook_rich_desert_revival_draught}));
}
...
GS1_REGISTER_SOURCE_SYSTEM_TEST(
    "technology",
    "first_basic_tier_auto_unlocks_with_faction_requirement",
    technology_first_basic_tier_auto_unlocks_with_faction_requirement);
GS1_REGISTER_SOURCE_SYSTEM_TEST(
    "technology",
    "auto_unlock_uses_node_faction_reputation_not_selected_tab",
    technology_auto_unlock_uses_node_faction_reputation_not_selected_tab);
GS1_REGISTER_SOURCE_SYSTEM_TEST(
    "technology",
    "linear_tiers_auto_unlock_from_matching_reputation_bands",
    technology_linear_tiers_auto_unlock_from_matching_reputation_bands);
GS1_REGISTER_SOURCE_SYSTEM_TEST(
    "technology",
    "auto_unlocks_do_not_expose_claim_or_refund_actions",
    technology_auto_unlocks_do_not_expose_claim_or_refund_actions);
GS1_REGISTER_SOURCE_SYSTEM_TEST(
    "technology",
