...
- `campaign_progress_system_tests.cpp`: System tests for campaign progression behavior, including selected-site support assembly, objective-mode completion/failure messaging, faction-reputation rewards, occupied-reputation tech claims, tier unlock rules, amplification lockout, and regional-map tech-tree tab/open flow.
...
- `environment_worker_device_system_tests.cpp`: System tests across environment, worker, and device interactions, including directional wind-shadow coverage for plants, windbreak devices, and one-sided highway-protection weather waves.
