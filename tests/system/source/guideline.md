...
- `campaign_progress_system_tests.cpp`: System tests for campaign progression behavior, including dedicated campaign/site time-system coverage for the 30-real-minute in-game day contract, selected-site support assembly, objective-mode completion/failure messaging, non-decreasing faction-reputation rewards, one-by-one total-reputation plant unlocks, faction-branch tech gating, surcharge-aware faction-reputation spending, top-down tech refunds, persistent-campaign-cash tech purchases, and tech-tree open/tab flow from both the regional map and active site sessions.
