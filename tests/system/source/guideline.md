...
- `environment_worker_device_system_tests.cpp`: System tests across environment, worker, and device interactions, including directional wind-shadow coverage for plants, site-time-system-aligned weather phase countdowns, windbreak devices, and one-sided highway-protection weather waves.
