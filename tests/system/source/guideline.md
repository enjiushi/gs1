...
- `environment_worker_device_system_tests.cpp`: System tests across environment, worker, and device interactions, including the temporary Site 1 startup heat-VFX timeline, site-time-system-aligned weather timeline interpolation, directional wind-shadow coverage for plants, windbreak devices, and one-sided highway-protection weather waves.
