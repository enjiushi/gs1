...
- `action_ecology_placement_system_tests.cpp`: Cross-system regression tests for actions, ecology, placement, harvest-output insertion plus density setbacks, persistent item-based plant-mode rearming, checkerboard `2x2` plant occupancy, previous-frame work-efficiency-driven action timing/cost, multi-tile plant wind-exposure behavior, resolved tile-contribution-driven terrain updates, and highway-target sand-cover handling.
