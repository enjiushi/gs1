...
- `smoke/`: DLL-loading smoke host, scripted smoke flows, and visual smoke assets, including the browser-side site renderer, timed-modifier remaining-game-hour badge projection, the adapter FPS plus web/host/DLL frame-cost readout, RMB harvest context actions, and tuned low-profile straw checkerboard presentation.
