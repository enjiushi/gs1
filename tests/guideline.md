...
- `smoke/`: DLL-loading smoke host, scripted smoke flows, and visual smoke assets, including the browser-side site renderer, RMB harvest context actions, and tuned low-profile straw checkerboard presentation.
