...
| Faction reputation and tech | `Ready` | Linear `32`-tier faction-tech gating, shared total-reputation unlock gating, node ownership, and the content-update model are already strong enough for persistent-state design. |
