...
- `prototype_content.h`: Prototype content package declarations used by the current stub content path.
- `prototype_content.cpp`: Prototype content construction and seed-data implementation.
