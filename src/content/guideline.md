...
- `tables/`: External TSV authoring tables for the config-backed prototype content slices, including the site/campaign graph table plus campaign setup and seeded phone listings.
