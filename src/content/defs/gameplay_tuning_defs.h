...
struct EcologyTuning final
{
    ...
    float growth_gain_scale {0.0012f};
    float growth_loss_scale {0.0024f};
    float growth_gain_moisture_bonus_scale {0.0008f};
    float growth_gain_fertility_bonus_scale {0.0006f};
    ...
    float density_establishment_threshold {0.3f};
    float density_establishment_bonus {1.15f};
    float density_fragility_base {1.25f};
    float density_fragility_density_scale {0.5f};
    float density_growth_pressure_safe_threshold {0.45f};
    float density_loss_pressure_threshold {0.55f};
