...
- `plant_defs.h`: Plant/ecology definition types plus runtime accessors over the loaded plant table, including the full China-desert 10-plant prototype roster, authored resistance/tolerance-driven plant shelter reach plus fertility/salinity support values, per-plant harvest output metadata, and the starter straw checkerboard definition with its authored `2x2` footprint plus tuned steady-wither behavior used by directional shelter resolution.
