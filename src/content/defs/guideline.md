...
- `technology_defs.h`: Prototype progression definition records and runtime accessors, including faction-branch tech tiers, per-node reputation and cash costs, per-plant total-reputation unlock thresholds, starter plants available from campaign start, and placeholder faction tech nodes with remembered refundable reputation spend.
