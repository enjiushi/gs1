...
- `items.toml`: Item authoring content for runtime item definitions and item-domain metadata, including internal cash-point valuation used by task/reward scoring, the full prototype seed-item roster, and harvested-good items for the China-desert ten-plant set.
