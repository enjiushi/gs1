...
- `plants.toml`: Plant authoring content for ecology, explicit focus tags, the authored six-meter roster-pool model (`salt`, `heat`, `wind`, `dust`, `fertility`, `output`), footprint-multiple aura and wind shelter reach, authored nearby-protection ratios over resistance-driven outward shelter, salt-derived plant salinity rehab for support foci, and per-plant harvest thresholds/output tuning across the full prototype China-desert 10-plant roster.
