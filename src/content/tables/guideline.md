...
- `plants.toml`: Plant authoring content for ecology, planting behavior, footprint-multiple aura and wind shelter reach, authored nearby-protection ratios over resistance-driven outward shelter, terrain-rehab support, and per-plant harvest thresholds/output tuning across the full prototype China-desert 10-plant roster, including the current lower exposed-resistance tuning for `Ordos Wormwood`.
