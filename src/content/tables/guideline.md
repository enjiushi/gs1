...
- `site_actions.toml`: Site action tuning content for shared action duration and worker energy/hydration/nourishment costs, placement occupancy, and reservation/approach/movement flags, with craft duration and worker meter costs authored per recipe and the shared harvest action profile still loaded here.
