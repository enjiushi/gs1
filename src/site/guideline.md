...
- `systems/`: Site system declarations and implementations, including harvest action execution, ecology harvest resolution, worker-pack harvest insertion, and the Village-specific shovel, excavation-depth, buff, and custom-food runtime hooks.
