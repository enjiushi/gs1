...
- `phone_panel_system.cpp`: Owns phone home/app-panel section state plus tracked phone open-close visibility and authoritative projected phone listings/task counts for the adapter, including completed and claimed history counts, while intentionally filtering frozen contractor offers out of the current player-facing phone projection.
