...
- `weather_event_system.cpp`: Applies incoming weather events to site-owned weather/event state, including start/peak/end timeline interpolation, the temporary Site 1 heat-VFX startup pulse, and recurring one-sided highway-protection waves.
