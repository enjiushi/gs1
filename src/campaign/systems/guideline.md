...
- `technology_system.cpp`: Technology system implementation for per-plant total-reputation unlock thresholds, faction base-tech purchases gated by faction-reputation tiers `1-8`, paired enhancement purchases gated by faction-reputation tiers `9-16` plus owned base techs, exclusive enhancement choices, top-down money refunds by reputation band, internal-cash-point campaign spending/refunds behind player-facing cash labels, and reputation-scaled tech-effect parameter helpers.
