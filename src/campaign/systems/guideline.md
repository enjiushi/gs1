...
- `faction_reputation_system.h`: Campaign faction-reputation system interface, including direct runtime message subscription declarations through the shared `RuntimeInvocation` system interface.
...
- `loadout_planner_system.h`: Loadout planner system interface, including direct runtime message subscription declarations through the shared `RuntimeInvocation` system interface.
...
- `technology_system.h`: Technology system interface for research/unlock progression, including direct runtime message/host subscription declarations through the shared `RuntimeInvocation` system interface while preserving external read-only unlock query helpers.
