...
- `systems/`: Campaign system declarations and implementations, including faction-reputation and technology progression handlers for the linear `32`-tier-per-faction tech ladder, total-reputation unlockables, and persistent campaign-cash tech purchases.
- `technology_state.h`: Campaign technology progression, purchased-node records for tier-exclusive tech selections, campaign-wide total-reputation tracking for plant unlocks, and persistent campaign cash.
