...
- `host/`: GS1-owned host bridge sources and headers used by the gameplay DLL hosts and Godot adapter, after the earlier shared-framework extraction was rolled back for GS1-specific host/session code.
