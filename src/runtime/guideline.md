...
- `game_runtime.cpp`: Runtime loop implementation, integration wiring, projected engine/HUD message emission, and authoritative phone panel state plus phone listing projection emission.
