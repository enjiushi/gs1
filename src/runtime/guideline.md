...
- `game_runtime.cpp`: Runtime loop implementation, integration wiring, projected engine/HUD message emission, and authoritative phone listing upsert/remove projection emission.
