...
- `system_interface.h`: Shared runtime system interface plus small implementation macros used by individual campaign/site systems so they can expose direct message/host/feedback subscription lists and use `GameRuntimeTempBridge` locally without a separate central runtime-system source file.
