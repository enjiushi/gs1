...
- `presentation_runtime_state.h`: Runtime-owned non-authoritative presentation caches such as phone-panel open/tab/badge session state, last-emitted phone listing ids, coarse presentation-dirty revision tracking, and campaign unlock cue snapshots moved out of the old presentation coordinator object.
