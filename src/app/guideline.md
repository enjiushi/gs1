...
- `site_run_factory.cpp`: Site-run factory implementation, initialization wiring, single-crate near-camp delivery bootstrap placement, initialization of tile-projection cache state, and site-one onboarding state seeding such as the starter workbench plus authored near-camp starter plant patches.
