...
- `site_run_factory.cpp`: Site-run factory implementation, initialization wiring, single-crate near-camp delivery bootstrap placement, and site-one onboarding state seeding such as the damaged starter workbench and nearby burial drift.
