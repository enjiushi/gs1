...
- `scripts/`: Reserved for unavoidable Godot project scripts; the main client shell controller still lives in the native plugin layer, and the only tracked script here is the menu-backdrop character retarget helper.
