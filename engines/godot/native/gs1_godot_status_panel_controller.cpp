...
bool Gs1GodotStatusPanelController::handles_notification(Gs1GodotNotificationType type) const noexcept
{
...
void Gs1GodotStatusPanelController::handle_notification(const Gs1GodotNotification& message)
{
