...
bool Gs1GodotRegionalMapUiController::handles_notification(Gs1GodotNotificationType type) const noexcept
{
    return type == GS1_GODOT_NOTIFICATION_PRESENTATION_DIRTY ||
        type == GS1_GODOT_NOTIFICATION_SET_APP_STATE;
}

void Gs1GodotRegionalMapUiController::handle_notification(const Gs1GodotNotification& message)
{
