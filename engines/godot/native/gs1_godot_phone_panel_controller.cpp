...
bool Gs1GodotPhonePanelController::handles_notification(Gs1GodotNotificationType type) const noexcept
{
    switch (type)
    {
...
void Gs1GodotPhonePanelController::handle_notification(const Gs1GodotNotification& message)
{
    switch (message.type)
    {
    case GS1_GODOT_NOTIFICATION_PRESENTATION_DIRTY:
