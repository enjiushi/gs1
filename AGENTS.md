...
- `TODO_REFACTOR.md`: Working checklist for the split-state/runtime refactor, including what is already complete in the production no-compat path and the remaining narrow non-production compatibility-removal targets in tests and view rebuild helpers.
