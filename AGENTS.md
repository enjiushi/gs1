...
- `CONTENT_AUTHORING_CONTRACT.md`: Content authoring contract and data expectations, including the current simplified harsh-weather timeline fields plus the authored plant-focus schema, the six-meter plant roster pool, output-meter-to-harvest-value alignment, excavation-only stone-merchandise item rules, `100%` excavation loot-table validation, and salt-derived plant salinity-rehab rules.
