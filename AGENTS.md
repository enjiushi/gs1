...
- `include/gs1/types.h`: Public API data types, message/event payload structs, runtime-facing enums, claimed-task/phone-panel transport fields, site-weather event timeline transport fields, tech-tree view/selection action identifiers, and harvest-action plus harvested-output transport payloads.
