...
- `src/host/`: Legacy placeholder folder retained only for its guideline after the engine-agnostic runtime-DLL host bridge moved into `shared_framework/core/host/`.
