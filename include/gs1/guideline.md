...
- `types.h`: Shared API structs, payloads, engine-message transport layouts, handles, and enums used by runtime callers, including authoritative phone-panel task-count transport, claimed-task list-kind projection, weather-event timeline payloads, and regional-map tech-tree UI setup/action identifiers.
