...
- `types.h`: Shared API structs, payloads, engine-message transport layouts, handles, and enums used by runtime callers, including authoritative phone-panel section transport plus regional-map tech-tree UI setup/action identifiers.
